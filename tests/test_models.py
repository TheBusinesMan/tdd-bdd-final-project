...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_with_key_error(self):
        """It should raise a DataValidationError when a key is missing"""
        product = Product()
        data = {"name": "Test", "price": "10.0"}  # Missing description/category
        self.assertRaises(DataValidationError, product.deserialize, data)

    def test_deserialize_with_type_error(self):
        """It should raise a DataValidationError when data is the wrong type"""
        product = Product()
    ...
    def test_deserialize_with_attribute_error(self):
        ...
        data = {
            ...
            "price": "10.0",
            "available": True,
            "category": "NOT_A_CATEGORY"  # This triggers AttributeError
        }
        self.assertRaises(DataValidationError, product.deserialize, data)
    ...
    def test_find_by_price_string(self):
        ...
        for product in products:
            product.create()
        # Passing a string triggers line 220 in models.py
